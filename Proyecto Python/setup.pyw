        ...
        if (os.access(rutaHosts,os.F_OK)):
            ...
            if(os.access(rutaHosts,os.W_OK)):
                ...
                while Referencia=="#REF!" and Intentos<10:
                    # Extraer IPs de JSON
                    ListaJSON = get("https://sheets.googleapis.com/v4/spreadsheets/1NrrqCMZ3LcyL81fQpSD3C33XcffQbkzrgw6yWXCCjO4/values/webs!A2:A?key=AIzaSyBIwM6uww1cw0vxk-4uEPkhY_5QzNE4ixI").json()["values"]
                    
                    Referencia=ListaJSON[0][0] # Guardar resultado de referencia
